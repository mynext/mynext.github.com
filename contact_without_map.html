...
<head>
    ...
    <title>Contact Without Map | Bolder Premium Wordpress Theme</title>
        ...
        <div class="inner">                 
			<div class="text">
				...
				<p>
					...
					Nulla scelerisque convallis adipiscing. Nunc leo dolor, 
					fringilla quis egestas eget, hendrerit id velit. Etiam sed 
					nibh purus, a volutpat quam. In hac habitasse platea dictumst. 
					Phasellus ultrices purus et sapien laoreet fermentum.
				</p>
            ...
            <div class="sidebar">     
				...
				<div class="widget">
	                ...
	                <ul>                           
	                    <li id="phone-icon"><strong>CALL US:</strong> + 034 567921</li>
	                    <li id="fax-icon"><strong>FAX US:</strong> + 034 567921</li>                     
	                </ul>
	            </div>                        
